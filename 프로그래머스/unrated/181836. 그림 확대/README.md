...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>.xx...xx.
x..x.x..x
x...x...x
.x.....x.
..x...x..
...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>..xxxx......xxxx..
..xxxx......xxxx..
xx....xx..xx....xx
xx....xx..xx....xx
xx......xx......xx
...
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>x.x
.x.
x.x
</code><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre></div>
<p>이를 가로 세로로 <code>k</code>배, 즉 3배 확대하면 그림 파일은 다음과 같습니다.</p>
<div class="highlight"><pre class="codehilite" style="position: relative;"><code>xxx...xxx
xxx...xxx
xxx...xxx
...xxx...
...xxx...
